# question 1
print('Question 1 [a new string]:')
starting_string = 'Small talk is light conversation'
print(starting_string)

# question 2
print('\nQuestion 2 [slices of the string]:')
...
# question 3
print('\nQuestion 3 [every word first letter capitalized]:')
q3_string = starting_string.title()
print(q3_string)

# question 4
print('\nQuestion 4 [string to list via space delimiter]:')
q4_list = starting_string.split(' ')
print(q4_list)

# question 5
print('\nQuestion 5 [string where space is replaced with -]:')
q5_string = starting_string.replace(' ', '-')
print(q5_string)

# question 6
print('\nQuestion 6 [string to list via - delimiter]:')
q6_list = q5_string.split('-')
print(q6_list)

# question 7
print('\nQuestion 7 [string joined with . from the list above]:')
q7_string = '.'.join(q6_list)
print(q7_string)

# question 8
print('\nQuestion 8 [a list of words]:')
q89_list = ['Let', 'me', 'see', 'if', 'I', 'understand', 'this']
print(q89_list)

# question 9
print('\nQuestion 9 [sorted list of words]:')
q89_list.sort()
print(q89_list)

# question 10
print('\nQuestion 10 [list of numbers]:')
q1011_list = [56, 23, 18, 32, 94, 37, 82]
print(q1011_list)

# question 11
print('\nQuestion 11 [sorted (lowest to highest) list of numbers]:')
q1011_list.sort()
print(q1011_list)

# question 12
print('\nQuestion 12 [list of colors]:')
...
print('\nQuestion 13 [sorted list of colors using function in order of rainbow colors]:')
